...
public class MyChatServerHandler extends SimpleChannelInboundHandler<String> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, String msg) throws Exception {
        ...
        channelGroup.forEach(ch -> {
            if (channel != ch) {
                ch.writeAndFlush("【广播】 - " + channel.remoteAddress() + " 发送的消息:" + msg + " \n");
            } else {
                ch.writeAndFlush("【回声】" + msg + " \n");
            }
        });
    }
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        Channel channel = ctx.channel();
        System.out.println("【channelActive】" + channel.remoteAddress() + " 上线了");
    }

    @Override
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        Channel channel = ctx.channel();
        System.out.println("【channelInactive】" + channel.remoteAddress() + " 下线了");
    }

    @Override
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        System.out.println("ChannelInboundHandler exceptionCaught");
