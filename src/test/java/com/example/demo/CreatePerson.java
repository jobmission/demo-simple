...
//    private static String[] phonePrefix = "130,131,132,133,134,135,136,137,138,139,150,151,152,153,155,156,157,158,159,166,176,177,186,188".split(",");
//
...
//        int year = getNum(1980, 2019);
//        int month = getNum(1, 12);
//        int day = getNum(1, 28);
//        int hour = getNum(0, 23);
//        int minute = getNum(0, 59);
...
//        map.put("gender", name_gender);
//        map.put("address", getAddress());
//        map.put("phone", getPhone());
//        map.put("email", getEmail(6, 9));
//        map.put("birthday", getDate());
//        return map;
//    }
//
//    @Disabled
...
//            personEntity.setName(getChineseName());
//            personEntity.setEmail(getEmail(6, 9));
//            personEntity.setPhone(getPhone());
//            personEntity.setGender(name_gender);
//            personEntity.setAddress(getAddress());
//            personEntityList.add(personEntity);
//
//            if (personEntityList.size() == 5000) {
//                System.out.println(new Date());
//                personEntityMapper.batchInsert(personEntityList);
...
//
//            PersonEntity personEntity = new PersonEntity();
//            personEntity.setId(IdWorker.getSingleton(1, 1).nextId());
//            personEntity.setName(getChineseName());
//            personEntity.setEmail(getEmail(6, 9));
//            personEntity.setPhone(getPhone());
//            personEntity.setGender(name_gender);
...
//
//            try {
//                personEntity.setBirthday(dateFormat.parse(getDate()));
//            } catch (ParseException e) {
//                e.printStackTrace();
//            }
//            personEntity.setDateCreated(new Date());
//            IndexRequest request = new IndexRequest("course");
//            request.source(JSONUtil.objectToJSONString(personEntity), XContentType.JSON);
